...
# -------------------------
SERVICES = {
    "لايكات تيك توك سريعه 👍😂": "لايكات تيك توك سريعه 👍😂",
    "مشاهدات تيك توك(مليون) 💁😂": "مشاهدات تيك توك(مليون) 💁😂",
    "لايكات انستا جديده ❗️😂": "لايكات انستا جديده ❗️😂",
    "مشاهدات ريلز انستا(مليون) ▶️😂": "مشاهدات ريلز انستا(مليون) ▶️😂"
}
# -------------------------
# التحقق من الاشتراك
# -------------------------
